...
export default function BurgerIngredients() {
  ...
  const clickScrollHandler = () => {
    if (bunHeaderElem && sauceHeaderElem && mainHeaderElem) {
      const element = current === 'buns' ? bunHeaderElem : current === 'sauces' ? sauceHeaderElem : mainHeaderElem;
  ...
  return (
    <>
      <div className={burgerIngredientsStyles.container}>
        ...
        <div ref={ingredientsRef} onScroll={setTabActiveHandler} className={burgerIngredientsStyles.categories}>
